									...
									<c:forEach items="${pageInfo.list}" var="user">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/user/del.do?id=${user.id}" class="btn bg-olive btn-xs">删除用户</a>
												<a href="${pageContext.request.contextPath}/user/findUserByIdAndOtherRole.do?id=${user.id}" class="btn bg-olive btn-xs">添加所属角色</a>
												<a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole.do?id=${user.id}" class="btn bg-olive btn-xs">删除所属角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
							...
							<ul class="pagination">
								...
								<c:forEach var="i" begin="${pageInfo.navigateFirstPage}" end="${pageInfo.navigateLastPage}" >
									<c:if test="${pageInfo.pageNum == i}">
										<li class="active"><a href="${pageContext.request.contextPath}/orders/findAll.do?page=${i}&size=${pageInfo.pageSize}">${i}</a></li>
									</c:if>
									<c:if test="${pageInfo.pageNum != i}">
								...
								<li>
									...
									<a href="${pageContext.request.contextPath}/orders/findAll.do?page=${pageInfo.nextPage}&size=${pageInfo.pageSize}">上一页</a>
									</c:if>
									<c:if test="${!pageInfo.hasNextPage}">
									<a>下一页</a>
									</c:if>
