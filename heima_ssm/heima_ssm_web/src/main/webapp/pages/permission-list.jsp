									...
									<c:forEach items="${pageInfo.list}" var="permission">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/pages/permission-add.jsp" class="btn bg-olive btn-xs">添加资源权限</a>
												<a href="${pageContext.request.contextPath}/permission/del.do?id=${permission.id}" class="btn bg-olive btn-xs">删除资源权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
